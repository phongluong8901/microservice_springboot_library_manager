package com.laptrinhfulllstack.notificationservice.event;
...
import com.laptrinhfulllstack.commonservice.services.EmailService;
...
public class EventConsumer {
    ...
    @KafkaListener(topics = "testMail", containerFactory = "kafkaListenerContainerFactory")
    public void testEmail(String message) {
        ...
        String template = "<div>\n" +
                ...
                "</div>";
        String filledTemplate = String.format(template, "Phong pro", message);

        emailService.sendEmail(message, "Thanks for buy my course", filledTemplate, true, null);
    }

    @KafkaListener(topics = "emailTeamplate", containerFactory = "kafkaListenerContainerFactory")
    public void emailTemplate(String message) {
        ...
        emailService.sendEmailWithTemplate(message, "Welcome to Job", "emailTemplate.ftl", placeholders, null);
    }
}
